...
# AWS EBS Default Encryption Terraform Module Example

This module enables default encryption for all new EBS volumes in an AWS account. When default encryption is enabled, all new EBS volumes are encrypted by default using the specified KMS key.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_ebs"></a> [ebs](#module\_ebs) | ../../../modules/ebs | n/a |
