...
# AWS Config Terraform Module Example

This module creates an AWS Config for an organization account. AWS Config is a service that enables you to assess, audit, and evaluate the configurations of your AWS resources.
