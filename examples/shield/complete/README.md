...
# AWS Shield Terraform Module Complete Example

This module enables AWS Shield in an AWS account. AWS Shield is a managed Distributed Denial of Service (DDoS) protection service that safeguards applications running on AWS. This module enables Shield for all resources in the specified region of the account.
